...
def np():                                             #schleife zum aktualisieren der ws2812's anhand der Limit-Werte aus der Edumap
...
def oled_w():                                         #schleife zum aktualisieren des Displays
    global data_b, data_t, data_h, data_p, data_c, data_n, index_list
...
def sensors_read():                                   #schleife zum auslesen aller Sensoren
