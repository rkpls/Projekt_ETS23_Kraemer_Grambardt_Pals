...
display = sh1106.SH1106_SPI(128, 64, spi, Pin(pin_dc), Pin(pin_res), Pin(pin_cs))
...
while True:
    ...
    display.fill(0)
    display.text(t_s, 0, 0, 1)
    display.text(h_s, 64, 0, 1)
    display.text(b_s, 0, 16, 1)
    display.text(c_s, 64, 16, 1)
    display.text(b_s, 0, 32, 1)
    display.text("-", 64, 32, 1)
    display.text("-", 0, 48, 1)
    display.text("-", 64, 48, 1)
    display.show()
    sleep_ms(1000)
